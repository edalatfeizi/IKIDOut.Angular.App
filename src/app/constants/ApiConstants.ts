...
export const BaseUrl = isDevMode() ? 'https://localhost:7037/' : 'http://ikidout.ikidmis.com/';
...
export const API_DOWNLOAD_PERSON_IMAGE_URL = BaseUrl + API_V1 + 'Personely/image';
...
export const API_GET_PRODUCT_SEND_OUT_FLOWS = BaseUrl + API_V1 + 'ProductSendOutFlow/all';
